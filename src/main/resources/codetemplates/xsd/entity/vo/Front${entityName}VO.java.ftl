...
<#if swagger2>
@ApiModel(value="Front${entity}VO"<#if table.comment! != ''>, description="${table.comment!}VO"</#if>)
</#if>
public class Front${entity}VO implements Serializable {
...
<#if entityColumnConstant>
	...
	public static Front${entity}VO of(${entity} ${cfg.entityVar}) {
        Front${entity}VO vo = new Front${entity}VO();

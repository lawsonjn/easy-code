...
import ${.globals["/repository/jpa/$\{entityName}Repository.java.ftl"]};
...
<#else>
public class ${table.serviceImplName} extends ${superServiceImplClass}<${entity}Repository, ${entity}, ${cfg.idType}> implements ${table.serviceName} {
